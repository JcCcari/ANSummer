...
uses
  Classes, SysUtils, strutils, resultmethods, parsemath;
type
  TOpenMethod = class
    private
    ...
    public
      function newton(x: Double; funExpression, funDExpression: string; e: double): TResultM;
      function secante(x: Double; funExpression: string; e: double): TResultM;
...
function TOpenMethod.newton(x: Double; funExpression, funDExpression: string; e: double): TResultM;
var
  fun, fund: TParseMath;
...
begin
  ...
  Result.XnList.Add( FloatToStr(xn_1) );
...
function TOpenMethod.secante(x: Double; funExpression: string; e: double): TResultM;
var
