...
uses
  Classes, SysUtils, Dialogs,math ,ParseMath,resultmethods;
type
...
type
  TClosedMethods = class
    ...
    public
      ...
      function bisectionMethod(a: Double; b:Double; e: Double; FExpression: string): TResultM;
      function fakePositionMethod(a: double; b: double; e: double; FExpression: string): TResultM;
  end;
...
function TClosedMethods.bisectionMethod(a: Double; b:Double; e: Double; FExpression: string ): TResultM ;
var
  fun: TParseMath;
  ...
  i,j: Integer;
begin
    Result.AList := TStringList.Create;
    Result.BList := TStringList.Create;
    Result.XnList := TStringList.Create;
    Result.SignList := TStringList.Create;
    Result.ErrorList := TStringList.Create;
  ...
  //Bisection method
    ...
    Result.AList.Add( FloatToStr(a) );
    Result.BList.Add( FloatToStr(b) );
    Result.XnList.Add( FloatToStr(xn) );
    Result.SignList.Add( FloatToStr(signo) );
    ...
    begin
        ...
        begin
          ...
          begin
            ...
            Result.XnList.Add( FloatToStr(xn) );
            Result.SignList.Add( FloatToStr(signo) );
            Result.ErrorList.Add( FloatToStr(eAbs) );
...
function TClosedMethods.fakePositionMethod(a: Double; b:Double; e: Double; FExpression: string ): TResultM ;
var
  fun: TParseMath;
  eAbs: Double; // absolute error
  xn: Double; // xr
